...
begin
repo, issue_text, head_sha, source_path, packet_path = ARGV
reject("usage: publish-review-result.rb REPOSITORY_ROOT ISSUE HEAD_SHA SOURCE [PACKET]") unless source_path
