...
workflow_transition_allowed() {
  ...
  case "$from:$to" in
    proposed:approved|proposed:blocked:user|proposed:superseded|approved:claimed|approved:blocked:dependency|approved:paused|approved:superseded|claimed:in-progress|claimed:blocked:conflict|claimed:paused|in-progress:verify-passed|in-progress:paused|verify-passed:review-requested|verify-passed:approved-for-merge|verify-passed:in-progress|verify-passed:blocked:review|review-requested:changes-requested|review-requested:approved-for-merge|review-requested:blocked:review|changes-requested:in-progress|changes-requested:blocked:user|changes-requested:paused|approved-for-merge:merged|approved-for-merge:in-progress|approved-for-merge:blocked:conflict|approved-for-merge:blocked:ops|merged:done) return 0 ;;
